...
const STRINGS: Record<Lang, Dict> = {
  ru: {
    tagline: "Маркетплейс ручной работы Казахстана. Каждое изделие — от мастера, напрямую и без посредников.",
  ...
  kk: {
    tagline: "Қазақстанның қолжасау бұйымдары маркетплейсі. Әр бұйым — шебердің өзінен, делдалсыз.",
